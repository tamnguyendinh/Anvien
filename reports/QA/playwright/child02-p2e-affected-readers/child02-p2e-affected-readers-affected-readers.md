# Child 02 P2-E Playwright evidence

- Generated: 2026-08-13T16:16:47.111Z
...
- `Reports/qa/playwright/child02-p2e-affected-readers/screenshots/01-mounted-production-fixture.png`
- `Reports/qa/playwright/child02-p2e-affected-readers/screenshots/02-before-c09-tool-result.png`
- `Reports/qa/playwright/child02-p2e-affected-readers/screenshots/03-c09-exact-id-only.png`
- `Reports/qa/playwright/child02-p2e-affected-readers/screenshots/04-c10-ambiguous-fails-closed.png`
- `Reports/qa/playwright/child02-p2e-affected-readers/screenshots/05-c10-unique-persisted-reference.png`
- `Reports/qa/playwright/child02-p2e-affected-readers/screenshots/06-c11-lines-10-11-highlighted-line-12-excluded.png`
...
```json
{
  "backendRequests": [
    {
      "method": "GET",
      "url": "http://127.0.0.1:4848/api/repo?repo=qa-p2e&awaitAnalysis=true"
    },
    {
      "method": "GET",
    ...
    {
      "method": "GET",
      "url": "http://127.0.0.1:4848/api/file?path=src%2Funique.ts&repo=qa-p2e&startLine=0&endLine=60"
    }
  ],
  "fileRequest": {
    "path": "src/unique.ts",
