...
func lastNamedChildOfType(node *sitter.Node, kind string) *sitter.Node {
	if node == nil {
		return nil
	}
...
func normalizeSwiftType(raw string) string {
...
func baseSwiftType(raw string) string {
	value := normalizeSwiftType(raw)
