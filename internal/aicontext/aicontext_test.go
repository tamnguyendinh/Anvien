...
func TestGenerateAIContextFilesCreatesAndUpdatesManagedContext(t *testing.T) {
	...
	for _, want := range []string{
		...
		"## Never Do",
		"## MCP Tools",
		"App Layer, Functional Area, and ResolutionGap summaries",
		"`route_map`",
		"`shape_check`",
		"`api_impact`",
		"## Semantic Graph Fields",
		"`sourceSiteId`",
		"`ResolutionGap` nodes are persisted diagnostic facts",
		"non-actionable builtin/standard-library/test-framework references",
		"## Resources",
		"avmatrix://repos",
		"avmatrix://setup",
