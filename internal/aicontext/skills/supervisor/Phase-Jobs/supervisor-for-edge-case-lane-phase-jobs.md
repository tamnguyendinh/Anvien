...
- Supervisor must read the 7 most recent Edge Case reports in `reports/Edge-Case/`.
...
2. Check evidence for the Job ID and all unresolved reports.
   ...
   . Read the 7 most recent Edge Case reports in `reports/Edge-Case/`.
...
- Before ticking `Supervisor`, supervisor must read the 7 most recent Edge Case reports in `reports/Edge-Case/`.
