...
- Supervisor must read the 7 most recent QA reports in `reports/QA/`.
...
2. Check evidence for the Job ID and all unresolved reports.
   ...
   . Read the 7 most recent QA reports in `reports/QA/`.
...
- Before ticking `Supervisor`, supervisor must read the 7 most recent QA reports in `reports/QA/`.
