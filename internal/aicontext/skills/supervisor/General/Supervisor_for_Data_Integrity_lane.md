...
- `Mode 2 - Post-Completion Review`
  ...
  . Only then may you review bugfixes, follow-ups, reject/resubmit work, `current worktree`, or incidents that arise after completion.
...
- The evidence bundle must cover:
  ...
  . all same-head Data Integrity reports already present at review time and relevant to the reviewed invariant family must be consumed and independently verified
