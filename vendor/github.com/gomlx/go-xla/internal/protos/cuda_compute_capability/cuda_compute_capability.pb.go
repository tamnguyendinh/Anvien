...
const file_xla_stream_executor_cuda_cuda_compute_capability_proto_rawDesc = "" +
	"\n" +
	"6xla/stream_executor/cuda/cuda_compute_capability.proto\x12\x0fstream_executor\"\x9c\x02\n" +
	"\x1aCudaComputeCapabilityProto\x12\x14\n" +
	"\x05major\x18\x01 \x01(\x05R\x05major\x12\x14\n" +
	"\x05minor\x18\x02 \x01(\x05R\x05minor\x12i\n" +
	"\x11feature_extension\x18\x03 \x01(\x0e2<.stream_executor.CudaComputeCapabilityProto.FeatureExtensionR\x10featureExtension\"g\n" +
	"\x10FeatureExtension\x12\x0f\n" +
	"\vUNSPECIFIED\x10\x00\x12\b\n" +
	"\x04NONE\x10\x01\x12\x18\n" +
	"\x14ACCELERATED_FEATURES\x10\x02\x12\x1e\n" +
	"\x1aFAMILY_COMPATIBLE_FEATURES\x10\x03b\x06proto3"
