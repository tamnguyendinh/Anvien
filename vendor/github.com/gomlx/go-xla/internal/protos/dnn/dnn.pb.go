...
const file_xla_tsl_protobuf_dnn_proto_rawDesc = "" +
	"\n" +
	"\x1axla/tsl/protobuf/dnn.proto\x12\x13stream_executor.dnn\x1a\x1egoogle/protobuf/wrappers.proto\"\x91\x02\n" +
	...
	"\flayout_oneof\"\xba\x03\n" +
	"\x0eAlgorithmProto\x12\x17\n" +
	"\aalgo_id\x18\x01 \x01(\x03R\x06algoId\x12I\n" +
	"\tmath_type\x18\x02 \x01(\x0e2,.stream_executor.dnn.AlgorithmProto.MathTypeR\bmathType\x12W\n" +
	"\ftuning_knobs\x18\x04 \x03(\v24.stream_executor.dnn.AlgorithmProto.TuningKnobsEntryR\vtuningKnobs\x12.\n" +
	"\x11is_cudnn_frontend\x18\x05 \x01(\bB\x02\x18\x01R\x0fisCudnnFrontend\x12C\n" +
	"\x0eworkspace_size\x18\x06 \x01(\v2\x1c.google.protobuf.UInt64ValueR\rworkspaceSize\x1a>\n" +
	"\x10TuningKnobsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\x03R\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\x03R\x05value:\x028\x01\"0\n" +
	"\bMathType\x12\x10\n" +
	"\fDEFAULT_MATH\x10\x00\x12\x12\n" +
	"\x0eTENSOR_OP_MATH\x10\x01J\x04\b\x03\x10\x04\"\xa9\x02\n" +
	"\x14AlgorithmConfigProto\x12C\n" +
	"\talgorithm\x18\x01 \x01(\v2#.stream_executor.dnn.AlgorithmProtoH\x00R\talgorithm\x12W\n" +
	"\x14algorithm_no_scratch\x18\x02 \x01(\v2#.stream_executor.dnn.AlgorithmProtoH\x01R\x12algorithmNoScratch\x12#\n" +
	"\fscratch_size\x18\x03 \x01(\x03H\x02R\vscratchSizeB\x14\n" +
	"\x12optional_algorithmB\x1f\n" +
	"\x1doptional_algorithm_no_scratchB\x17\n" +
	"\x15optional_scratch_size\"\xb8\x02\n" +
	...
	"\x04name\x18\a \x01(\tR\x04name*\xfa\x01\n" +
	"\bDataType\x12\n" +
	"\n" +
	...
	"\x05kBF16\x10\a\x12\v\n" +
	"\akF8E5M2\x10\b\x12\r\n" +
	"\tkF8E4M3FN\x10\t\x12\x0f\n" +
	"\vkF8E5M2FNUZ\x10\n" +
	"\x12\x0f\n" +
	"\vkF8E4M3FNUZ\x10\v\x12\n" +
	"\n" +
	"\x06kInt64\x10\f\x12\v\n" +
	"\akF8E4M3\x10\r\x12\v\n" +
	"\akF8E3M4\x10\x0e\x12\r\n" +
	"\tkF4E2M1FN\x10\x0f\x12\x0e\n" +
	"\n" +
	"kF8E8M0FNU\x10\x10*\x81\x01\n" +
	"\n" +
	"DataLayout\x12\x11\n" +
	...
	"\x0fkBatchDepthYX32\x10\x05*\xae\x01\n" +
	...
	"\x10kOutputInputYX32\x10\x05\x12#\n" +
	"\x1fkOutputInputYX32_CudnnReordered\x10\x06\x12\x12\n" +
	...
	"\tkBandPass\x10\x06\x12\b\n" +
	"\x04kElu\x10\a\x12\x0e\n" +
	"\n" +
	"kLeakyRelu\x10\b\x12\x0e\n" +
	"\n" +
	"kGeluExact\x10\t*9\n" +
	"\x0fConvolutionMode\x12\x15\n" +
	"\x11CROSS_CORRELATION\x10\x00\x12\x0f\n" +
	"\vCONVOLUTION\x10\x01*\x83\x01\n" +
	...
	"\x17FORWARD_BIAS_ACTIVATION\x10\x04\x12\x11\n" +
	"\rFORWARD_GRAPH\x10\x05*C\n" +
	"\bNormKind\x12\x13\n" +
	"\x0fLAYER_FWD_INFER\x10\x00\x12\x13\n" +
	"\x0fLAYER_FWD_TRAIN\x10\x01\x12\r\n" +
	"\tLAYER_BWD\x10\x02*Z\n" +
	"\fFusedMHAKind\x12\x17\n" +
	"\x13BMM1_OUTPUT_UNKNOWN\x10\x00\x12\x1a\n" +
	"\x16BMM1_OUTPUT_INPUT_TYPE\x10\x01\x12\x15\n" +
	"\x11BMM1_OUTPUT_FLOAT\x10\x02*S\n" +
	"\fFMHAMaskKind\x12\v\n" +
	"\aNO_MASK\x10\x00\x12\v\n" +
	"\aPADDING\x10\x01\x12\n" +
	"\n" +
	"\x06CAUSAL\x10\x02\x12\x12\n" +
	"\x0ePADDING_CAUSAL\x10\x03\x12\t\n" +
	"\x05ALIBI\x10\x04b\x06proto3"
