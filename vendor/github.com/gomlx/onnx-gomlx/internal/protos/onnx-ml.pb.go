...
func (TensorProto_DataType) EnumDescriptor() ([]byte, []int) {
	return file_onnx_ml_proto_rawDescGZIP(), []int{14, 0}
}
...
func (TensorProto_DataLocation) EnumDescriptor() ([]byte, []int) {
	return file_onnx_ml_proto_rawDescGZIP(), []int{14, 1}
}
...
func (*TensorProto) Descriptor() ([]byte, []int) {
	return file_onnx_ml_proto_rawDescGZIP(), []int{14}
}
...
func (*SparseTensorProto) Descriptor() ([]byte, []int) {
	return file_onnx_ml_proto_rawDescGZIP(), []int{15}
}
...
func (*TensorShapeProto) Descriptor() ([]byte, []int) {
	return file_onnx_ml_proto_rawDescGZIP(), []int{16}
}
...
func (*TypeProto) Descriptor() ([]byte, []int) {
	return file_onnx_ml_proto_rawDescGZIP(), []int{17}
}
...
func (x *TypeProto) GetOpaqueType() *TypeProto_Opaque {
	if x != nil {
		if x, ok := x.Value.(*TypeProto_OpaqueType); ok {
			return x.OpaqueType
		}
	}
	return nil
...
func (*OperatorSetIdProto) Descriptor() ([]byte, []int) {
	return file_onnx_ml_proto_rawDescGZIP(), []int{18}
}
...
func (*FunctionProto) Descriptor() ([]byte, []int) {
	return file_onnx_ml_proto_rawDescGZIP(), []int{19}
}
...
func (*TensorShapeProto_Dimension) Descriptor() ([]byte, []int) {
	return file_onnx_ml_proto_rawDescGZIP(), []int{16, 0}
}
...
func (x *TypeProto_Tensor) Reset() {
	*x = TypeProto_Tensor{}
	mi := &file_onnx_ml_proto_msgTypes[22]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*TypeProto_Tensor) Descriptor() ([]byte, []int) {
	return file_onnx_ml_proto_rawDescGZIP(), []int{17, 0}
}
...
func (x *TypeProto_Sequence) Reset() {
	*x = TypeProto_Sequence{}
	mi := &file_onnx_ml_proto_msgTypes[23]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*TypeProto_Sequence) Descriptor() ([]byte, []int) {
	return file_onnx_ml_proto_rawDescGZIP(), []int{17, 1}
}
...
func (x *TypeProto_Map) Reset() {
	*x = TypeProto_Map{}
	mi := &file_onnx_ml_proto_msgTypes[24]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*TypeProto_Map) Descriptor() ([]byte, []int) {
	return file_onnx_ml_proto_rawDescGZIP(), []int{17, 2}
}
...
func (x *TypeProto_Optional) Reset() {
	*x = TypeProto_Optional{}
	mi := &file_onnx_ml_proto_msgTypes[25]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*TypeProto_Optional) Descriptor() ([]byte, []int) {
	return file_onnx_ml_proto_rawDescGZIP(), []int{17, 3}
}
...
func (x *TypeProto_SparseTensor) Reset() {
	*x = TypeProto_SparseTensor{}
	mi := &file_onnx_ml_proto_msgTypes[26]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*TypeProto_SparseTensor) Descriptor() ([]byte, []int) {
	return file_onnx_ml_proto_rawDescGZIP(), []int{17, 4}
}
...
func (x *TypeProto_Opaque) Reset() {
	*x = TypeProto_Opaque{}
	mi := &file_onnx_ml_proto_msgTypes[27]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*TypeProto_Opaque) Descriptor() ([]byte, []int) {
	return file_onnx_ml_proto_rawDescGZIP(), []int{17, 5}
}
...
const file_onnx_ml_proto_rawDesc = "" +
	"\n" +
	"\ronnx-ml.proto\x12\x06protos\"\xf5\x06\n" +
	"\x0eAttributeProto\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\"\n" +
	"\rref_attr_name\x18\x15 \x01(\tR\vrefAttrName\x12\x1d\n" +
	"\n" +
	"doc_string\x18\r \x01(\tR\tdocString\x128\n" +
	"\x04type\x18\x14 \x01(\x0e2$.protos.AttributeProto.AttributeTypeR\x04type\x12\f\n" +
	"\x01f\x18\x02 \x01(\x02R\x01f\x12\f\n" +
	"\x01i\x18\x03 \x01(\x03R\x01i\x12\f\n" +
	"\x01s\x18\x04 \x01(\fR\x01s\x12!\n" +
	"\x01t\x18\x05 \x01(\v2\x13.protos.TensorProtoR\x01t\x12 \n" +
	"\x01g\x18\x06 \x01(\v2\x12.protos.GraphProtoR\x01g\x12>\n" +
	"\rsparse_tensor\x18\x16 \x01(\v2\x19.protos.SparseTensorProtoR\fsparseTensor\x12!\n" +
	"\x02tp\x18\x0e \x01(\v2\x11.protos.TypeProtoR\x02tp\x12\x16\n" +
	"\x06floats\x18\a \x03(\x02R\x06floats\x12\x12\n" +
	"\x04ints\x18\b \x03(\x03R\x04ints\x12\x18\n" +
	"\astrings\x18\t \x03(\fR\astrings\x12-\n" +
	"\atensors\x18\n" +
	" \x03(\v2\x13.protos.TensorProtoR\atensors\x12*\n" +
	"\x06graphs\x18\v \x03(\v2\x12.protos.GraphProtoR\x06graphs\x12@\n" +
	"\x0esparse_tensors\x18\x17 \x03(\v2\x19.protos.SparseTensorProtoR\rsparseTensors\x122\n" +
	"\vtype_protos\x18\x0f \x03(\v2\x11.protos.TypeProtoR\n" +
	"typeProtos\"\xd9\x01\n" +
	"\rAttributeType\x12\r\n" +
	...
	"\vTYPE_PROTOS\x10\x0eJ\x04\b\f\x10\rJ\x04\b\x10\x10\x14R\x01v\"\xb1\x01\n" +
	"\x0eValueInfoProto\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12%\n" +
	"\x04type\x18\x02 \x01(\v2\x11.protos.TypeProtoR\x04type\x12\x1d\n" +
	"\n" +
	"doc_string\x18\x03 \x01(\tR\tdocString\x12E\n" +
	"\x0emetadata_props\x18\x04 \x03(\v2\x1e.protos.StringStringEntryProtoR\rmetadataProps\"\x91\x03\n" +
	"\tNodeProto\x12\x14\n" +
	...
	"\boverload\x18\b \x01(\tR\boverload\x124\n" +
	"\tattribute\x18\x05 \x03(\v2\x16.protos.AttributeProtoR\tattribute\x12\x1d\n" +
	"\n" +
	"doc_string\x18\x06 \x01(\tR\tdocString\x12E\n" +
	"\x0emetadata_props\x18\t \x03(\v2\x1e.protos.StringStringEntryProtoR\rmetadataProps\x12Y\n" +
	"\x15device_configurations\x18\n" +
	" \x03(\v2$.protos.NodeDeviceConfigurationProtoR\x14deviceConfigurations\">\n" +
	"\x14IntIntListEntryProto\x12\x10\n" +
	"\x03key\x18\x01 \x01(\x03R\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x03(\x03R\x05value\"\xb0\x01\n" +
	"\x1cNodeDeviceConfigurationProto\x12)\n" +
	"\x10configuration_id\x18\x01 \x01(\tR\x0fconfigurationId\x12>\n" +
	"\rsharding_spec\x18\x02 \x03(\v2\x19.protos.ShardingSpecProtoR\fshardingSpec\x12%\n" +
	"\x0epipeline_stage\x18\x03 \x01(\x05R\rpipelineStage\"\xde\x01\n" +
	"\x11ShardingSpecProto\x12\x1f\n" +
	"\vtensor_name\x18\x01 \x01(\tR\n" +
	"tensorName\x12\x16\n" +
	"\x06device\x18\x02 \x03(\x03R\x06device\x12V\n" +
	"\x19index_to_device_group_map\x18\x03 \x03(\v2\x1c.protos.IntIntListEntryProtoR\x15indexToDeviceGroupMap\x128\n" +
	"\vsharded_dim\x18\x04 \x03(\v2\x17.protos.ShardedDimProtoR\n" +
	"shardedDim\"m\n" +
	"\x0fShardedDimProto\x12\x12\n" +
	"\x04axis\x18\x01 \x01(\x03R\x04axis\x12F\n" +
	"\x0fsimple_sharding\x18\x02 \x03(\v2\x1d.protos.SimpleShardedDimProtoR\x0esimpleSharding\"{\n" +
	...
	"\x0einitialization\x18\x01 \x01(\v2\x12.protos.GraphProtoR\x0einitialization\x120\n" +
	"\talgorithm\x18\x02 \x01(\v2\x12.protos.GraphProtoR\talgorithm\x12U\n" +
	"\x16initialization_binding\x18\x03 \x03(\v2\x1e.protos.StringStringEntryProtoR\x15initializationBinding\x12E\n" +
	"\x0eupdate_binding\x18\x04 \x03(\v2\x1e.protos.StringStringEntryProtoR\rupdateBinding\"\xc4\x04\n" +
	"\n" +
	"ModelProto\x12\x1d\n" +
	"\n" +
	"ir_version\x18\x01 \x01(\x03R\tirVersion\x12=\n" +
	"\fopset_import\x18\b \x03(\v2\x1a.protos.OperatorSetIdProtoR\vopsetImport\x12#\n" +
	...
	"\x05graph\x18\a \x01(\v2\x12.protos.GraphProtoR\x05graph\x12E\n" +
	"\x0emetadata_props\x18\x0e \x03(\v2\x1e.protos.StringStringEntryProtoR\rmetadataProps\x12>\n" +
	"\rtraining_info\x18\x14 \x03(\v2\x19.protos.TrainingInfoProtoR\ftrainingInfo\x123\n" +
	"\tfunctions\x18\x19 \x03(\v2\x15.protos.FunctionProtoR\tfunctions\x12F\n" +
	"\rconfiguration\x18\x1a \x03(\v2 .protos.DeviceConfigurationProtoR\rconfiguration\"g\n" +
	...
	"\vtensor_name\x18\x01 \x01(\tR\n" +
	"tensorName\x12_\n" +
	"\x1cquant_parameter_tensor_names\x18\x02 \x03(\v2\x1e.protos.StringStringEntryProtoR\x19quantParameterTensorNames\"\xdc\x04\n" +
	"\n" +
	"GraphProto\x12%\n" +
	"\x04node\x18\x01 \x03(\v2\x11.protos.NodeProtoR\x04node\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x125\n" +
	"\vinitializer\x18\x05 \x03(\v2\x13.protos.TensorProtoR\vinitializer\x12H\n" +
	"\x12sparse_initializer\x18\x0f \x03(\v2\x19.protos.SparseTensorProtoR\x11sparseInitializer\x12\x1d\n" +
	"\n" +
	"doc_string\x18\n" +
	" \x01(\tR\tdocString\x12,\n" +
	"\x05input\x18\v \x03(\v2\x16.protos.ValueInfoProtoR\x05input\x12.\n" +
	"\x06output\x18\f \x03(\v2\x16.protos.ValueInfoProtoR\x06output\x125\n" +
	"\n" +
	"value_info\x18\r \x03(\v2\x16.protos.ValueInfoProtoR\tvalueInfo\x12Q\n" +
	"\x17quantization_annotation\x18\x0e \x03(\v2\x18.protos.TensorAnnotationR\x16quantizationAnnotation\x12E\n" +
	"\x0emetadata_props\x18\x10 \x03(\v2\x1e.protos.StringStringEntryProtoR\rmetadataPropsJ\x04\b\x03\x10\x04J\x04\b\x04\x10\x05J\x04\b\x06\x10\n" +
	"R\n" +
	"ir_versionR\x10producer_versionR\fproducer_tagR\x06domain\"\xb9\b\n" +
	"\vTensorProto\x12\x12\n" +
	"\x04dims\x18\x01 \x03(\x03R\x04dims\x12\x1b\n" +
	"\tdata_type\x18\x02 \x01(\x05R\bdataType\x125\n" +
	"\asegment\x18\x03 \x01(\v2\x1b.protos.TensorProto.SegmentR\asegment\x12!\n" +
	"\n" +
	...
	"\braw_data\x18\t \x01(\fR\arawData\x12C\n" +
	"\rexternal_data\x18\r \x03(\v2\x1e.protos.StringStringEntryProtoR\fexternalData\x12E\n" +
	"\rdata_location\x18\x0e \x01(\x0e2 .protos.TensorProto.DataLocationR\fdataLocation\x12#\n" +
	"\vdouble_data\x18\n" +
	" \x03(\x01B\x02\x10\x01R\n" +
	"doubleData\x12#\n" +
	"\vuint64_data\x18\v \x03(\x04B\x02\x10\x01R\n" +
	"uint64Data\x12E\n" +
	"\x0emetadata_props\x18\x10 \x03(\v2\x1e.protos.StringStringEntryProtoR\rmetadataProps\x1a1\n" +
	"\aSegment\x12\x14\n" +
	...
	"\bEXTERNAL\x10\x01\"\x83\x01\n" +
	"\x11SparseTensorProto\x12+\n" +
	"\x06values\x18\x01 \x01(\v2\x13.protos.TensorProtoR\x06values\x12-\n" +
	"\aindices\x18\x02 \x01(\v2\x13.protos.TensorProtoR\aindices\x12\x12\n" +
	"\x04dims\x18\x03 \x03(\x03R\x04dims\"\xbc\x01\n" +
	"\x10TensorShapeProto\x124\n" +
	"\x03dim\x18\x01 \x03(\v2\".protos.TensorShapeProto.DimensionR\x03dim\x1ar\n" +
	"\tDimension\x12\x1d\n" +
	"\tdim_value\x18\x01 \x01(\x03H\x00R\bdimValue\x12\x1d\n" +
	...
	"tensorType\x12A\n" +
	"\rsequence_type\x18\x04 \x01(\v2\x1a.protos.TypeProto.SequenceH\x00R\fsequenceType\x122\n" +
	"\bmap_type\x18\x05 \x01(\v2\x15.protos.TypeProto.MapH\x00R\amapType\x12A\n" +
	"\roptional_type\x18\t \x01(\v2\x1a.protos.TypeProto.OptionalH\x00R\foptionalType\x12N\n" +
	"\x12sparse_tensor_type\x18\b \x01(\v2\x1e.protos.TypeProto.SparseTensorH\x00R\x10sparseTensorType\x12;\n" +
	"\vopaque_type\x18\a \x01(\v2\x18.protos.TypeProto.OpaqueH\x00R\n" +
	"opaqueType\x12\x1e\n" +
	"\n" +
	...
	"\x05shape\x18\x02 \x01(\v2\x18.protos.TensorShapeProtoR\x05shape\x1a:\n" +
	"\bSequence\x12.\n" +
	"\telem_type\x18\x01 \x01(\v2\x11.protos.TypeProtoR\belemType\x1aR\n" +
	"\x03Map\x12\x19\n" +
	"\bkey_type\x18\x01 \x01(\x05R\akeyType\x120\n" +
	"\n" +
	"value_type\x18\x02 \x01(\v2\x11.protos.TypeProtoR\tvalueType\x1a:\n" +
	"\bOptional\x12.\n" +
	...
	"\aversion\x18\x02 \x01(\x03R\aversion\"\x8a\x04\n" +
	...
	"\x0fattribute_proto\x18\v \x03(\v2\x16.protos.AttributeProtoR\x0eattributeProto\x12%\n" +
	"\x04node\x18\a \x03(\v2\x11.protos.NodeProtoR\x04node\x12\x1d\n" +
	"\n" +
	"doc_string\x18\b \x01(\tR\tdocString\x12=\n" +
	"\fopset_import\x18\t \x03(\v2\x1a.protos.OperatorSetIdProtoR\vopsetImport\x12\x16\n" +
	"\x06domain\x18\n" +
	...
	"\n" +
	"\x06STABLE\x10\x01B\x02H\x03b\x06proto3"

var (
	file_onnx_ml_proto_rawDescOnce sync.Once
	file_onnx_ml_proto_rawDescData []byte
)

func file_onnx_ml_proto_rawDescGZIP() []byte {
	file_onnx_ml_proto_rawDescOnce.Do(func() {
		file_onnx_ml_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_onnx_ml_proto_rawDesc), len(file_onnx_ml_proto_rawDesc)))
	})
	return file_onnx_ml_proto_rawDescData
}

var file_onnx_ml_proto_enumTypes = make([]protoimpl.EnumInfo, 5)
var file_onnx_ml_proto_msgTypes = make([]protoimpl.MessageInfo, 28)
var file_onnx_ml_proto_goTypes = []any{
	...
	(*IntIntListEntryProto)(nil),         // 8: protos.IntIntListEntryProto
	(*NodeDeviceConfigurationProto)(nil), // 9: protos.NodeDeviceConfigurationProto
	(*ShardingSpecProto)(nil),            // 10: protos.ShardingSpecProto
	(*ShardedDimProto)(nil),              // 11: protos.ShardedDimProto
	(*SimpleShardedDimProto)(nil),        // 12: protos.SimpleShardedDimProto
	(*TrainingInfoProto)(nil),            // 13: protos.TrainingInfoProto
	(*ModelProto)(nil),                   // 14: protos.ModelProto
	(*DeviceConfigurationProto)(nil),     // 15: protos.DeviceConfigurationProto
	(*StringStringEntryProto)(nil),       // 16: protos.StringStringEntryProto
	(*TensorAnnotation)(nil),             // 17: protos.TensorAnnotation
	(*GraphProto)(nil),                   // 18: protos.GraphProto
	(*TensorProto)(nil),                  // 19: protos.TensorProto
	(*SparseTensorProto)(nil),            // 20: protos.SparseTensorProto
	(*TensorShapeProto)(nil),             // 21: protos.TensorShapeProto
	(*TypeProto)(nil),                    // 22: protos.TypeProto
	(*OperatorSetIdProto)(nil),           // 23: protos.OperatorSetIdProto
	(*FunctionProto)(nil),                // 24: protos.FunctionProto
	(*TensorProto_Segment)(nil),          // 25: protos.TensorProto.Segment
	(*TensorShapeProto_Dimension)(nil),   // 26: protos.TensorShapeProto.Dimension
	(*TypeProto_Tensor)(nil),             // 27: protos.TypeProto.Tensor
	(*TypeProto_Sequence)(nil),           // 28: protos.TypeProto.Sequence
	(*TypeProto_Map)(nil),                // 29: protos.TypeProto.Map
	(*TypeProto_Optional)(nil),           // 30: protos.TypeProto.Optional
	(*TypeProto_SparseTensor)(nil),       // 31: protos.TypeProto.SparseTensor
	(*TypeProto_Opaque)(nil),             // 32: protos.TypeProto.Opaque
}
var file_onnx_ml_proto_depIdxs = []int32{
	2,  // 0: protos.AttributeProto.type:type_name -> protos.AttributeProto.AttributeType
	19, // 1: protos.AttributeProto.t:type_name -> protos.TensorProto
	18, // 2: protos.AttributeProto.g:type_name -> protos.GraphProto
	20, // 3: protos.AttributeProto.sparse_tensor:type_name -> protos.SparseTensorProto
	22, // 4: protos.AttributeProto.tp:type_name -> protos.TypeProto
	19, // 5: protos.AttributeProto.tensors:type_name -> protos.TensorProto
	18, // 6: protos.AttributeProto.graphs:type_name -> protos.GraphProto
	20, // 7: protos.AttributeProto.sparse_tensors:type_name -> protos.SparseTensorProto
	22, // 8: protos.AttributeProto.type_protos:type_name -> protos.TypeProto
	22, // 9: protos.ValueInfoProto.type:type_name -> protos.TypeProto
	16, // 10: protos.ValueInfoProto.metadata_props:type_name -> protos.StringStringEntryProto
	5,  // 11: protos.NodeProto.attribute:type_name -> protos.AttributeProto
	16, // 12: protos.NodeProto.metadata_props:type_name -> protos.StringStringEntryProto
	9,  // 13: protos.NodeProto.device_configurations:type_name -> protos.NodeDeviceConfigurationProto
	10, // 14: protos.NodeDeviceConfigurationProto.sharding_spec:type_name -> protos.ShardingSpecProto
	8,  // 15: protos.ShardingSpecProto.index_to_device_group_map:type_name -> protos.IntIntListEntryProto
	11, // 16: protos.ShardingSpecProto.sharded_dim:type_name -> protos.ShardedDimProto
	12, // 17: protos.ShardedDimProto.simple_sharding:type_name -> protos.SimpleShardedDimProto
	18, // 18: protos.TrainingInfoProto.initialization:type_name -> protos.GraphProto
	18, // 19: protos.TrainingInfoProto.algorithm:type_name -> protos.GraphProto
	16, // 20: protos.TrainingInfoProto.initialization_binding:type_name -> protos.StringStringEntryProto
	16, // 21: protos.TrainingInfoProto.update_binding:type_name -> protos.StringStringEntryProto
	23, // 22: protos.ModelProto.opset_import:type_name -> protos.OperatorSetIdProto
	18, // 23: protos.ModelProto.graph:type_name -> protos.GraphProto
	16, // 24: protos.ModelProto.metadata_props:type_name -> protos.StringStringEntryProto
	13, // 25: protos.ModelProto.training_info:type_name -> protos.TrainingInfoProto
	24, // 26: protos.ModelProto.functions:type_name -> protos.FunctionProto
	15, // 27: protos.ModelProto.configuration:type_name -> protos.DeviceConfigurationProto
	16, // 28: protos.TensorAnnotation.quant_parameter_tensor_names:type_name -> protos.StringStringEntryProto
	7,  // 29: protos.GraphProto.node:type_name -> protos.NodeProto
	19, // 30: protos.GraphProto.initializer:type_name -> protos.TensorProto
	20, // 31: protos.GraphProto.sparse_initializer:type_name -> protos.SparseTensorProto
	6,  // 32: protos.GraphProto.input:type_name -> protos.ValueInfoProto
	6,  // 33: protos.GraphProto.output:type_name -> protos.ValueInfoProto
	6,  // 34: protos.GraphProto.value_info:type_name -> protos.ValueInfoProto
	17, // 35: protos.GraphProto.quantization_annotation:type_name -> protos.TensorAnnotation
	16, // 36: protos.GraphProto.metadata_props:type_name -> protos.StringStringEntryProto
	25, // 37: protos.TensorProto.segment:type_name -> protos.TensorProto.Segment
	16, // 38: protos.TensorProto.external_data:type_name -> protos.StringStringEntryProto
	4,  // 39: protos.TensorProto.data_location:type_name -> protos.TensorProto.DataLocation
	16, // 40: protos.TensorProto.metadata_props:type_name -> protos.StringStringEntryProto
	19, // 41: protos.SparseTensorProto.values:type_name -> protos.TensorProto
	19, // 42: protos.SparseTensorProto.indices:type_name -> protos.TensorProto
	26, // 43: protos.TensorShapeProto.dim:type_name -> protos.TensorShapeProto.Dimension
	27, // 44: protos.TypeProto.tensor_type:type_name -> protos.TypeProto.Tensor
	28, // 45: protos.TypeProto.sequence_type:type_name -> protos.TypeProto.Sequence
	29, // 46: protos.TypeProto.map_type:type_name -> protos.TypeProto.Map
	30, // 47: protos.TypeProto.optional_type:type_name -> protos.TypeProto.Optional
	31, // 48: protos.TypeProto.sparse_tensor_type:type_name -> protos.TypeProto.SparseTensor
	32, // 49: protos.TypeProto.opaque_type:type_name -> protos.TypeProto.Opaque
	5,  // 50: protos.FunctionProto.attribute_proto:type_name -> protos.AttributeProto
	7,  // 51: protos.FunctionProto.node:type_name -> protos.NodeProto
	23, // 52: protos.FunctionProto.opset_import:type_name -> protos.OperatorSetIdProto
	6,  // 53: protos.FunctionProto.value_info:type_name -> protos.ValueInfoProto
	16, // 54: protos.FunctionProto.metadata_props:type_name -> protos.StringStringEntryProto
	21, // 55: protos.TypeProto.Tensor.shape:type_name -> protos.TensorShapeProto
	22, // 56: protos.TypeProto.Sequence.elem_type:type_name -> protos.TypeProto
	22, // 57: protos.TypeProto.Map.value_type:type_name -> protos.TypeProto
	22, // 58: protos.TypeProto.Optional.elem_type:type_name -> protos.TypeProto
	21, // 59: protos.TypeProto.SparseTensor.shape:type_name -> protos.TensorShapeProto
...
func file_onnx_ml_proto_init() {
	...
	file_onnx_ml_proto_msgTypes[7].OneofWrappers = []any{
		(*SimpleShardedDimProto_DimValue)(nil),
		(*SimpleShardedDimProto_DimParam)(nil),
	}
	file_onnx_ml_proto_msgTypes[17].OneofWrappers = []any{
	...
	file_onnx_ml_proto_msgTypes[21].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_onnx_ml_proto_rawDesc), len(file_onnx_ml_proto_rawDesc)),
			NumEnums:      5,
			NumMessages:   28,
			NumExtensions: 0,
			NumServices:   0,
