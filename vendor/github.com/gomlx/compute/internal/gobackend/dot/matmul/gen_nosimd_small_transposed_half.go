		...
		for row := range lhsCrossSize {
			...
			for col := range rhsCrossSize {
				...
				for ; contractingIdx+3 < contractingSize; contractingIdx += 4 {
					//alt:generic l0 := *(*I)(unsafe.Pointer(lIdx))
					//alt:generic l1 := *(*I)(unsafe.Pointer(lIdx + iSize))
					//alt:generic l2 := *(*I)(unsafe.Pointer(lIdx + 2*iSize))
					//alt:generic l3 := *(*I)(unsafe.Pointer(lIdx + 3*iSize))
					...
					l0 := (*(*I)(unsafe.Pointer(lIdx))).Float32()           //alt:half
					l1 := (*(*I)(unsafe.Pointer(lIdx + iSize))).Float32()   //alt:half
					l2 := (*(*I)(unsafe.Pointer(lIdx + 2*iSize))).Float32() //alt:half
					l3 := (*(*I)(unsafe.Pointer(lIdx + 3*iSize))).Float32() //alt:half
