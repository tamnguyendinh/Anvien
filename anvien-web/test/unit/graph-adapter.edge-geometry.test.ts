...
import type { GraphRelationship } from "../../src/generated/anvien-contracts";
import {
...
describe("knowledgeGraphToGraphology edge geometry", () => {
  ...
  it("applies App Layer and Resolution Health filters without changing node type colors", () => {
    ...
    const frontendFunction = {
      ...createFunctionNode("frontendHelper", "anvien-web/src/app.ts", 1),
      properties: {
        ...createFunctionNode("frontendHelper", "anvien-web/src/app.ts", 1)
          .properties,
        appLayer: "frontend",
