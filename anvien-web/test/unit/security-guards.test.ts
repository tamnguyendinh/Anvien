...
import { NODE_TABLES, REL_TYPES } from '@/generated/anvien-contracts';
...
//   isSafeId                   -- anvien-web/src/components/ProcessesPanel.tsx
//   readOnly guard (regex)     -- anvien/src/core/lbug/lbug-adapter.ts
// ---------------------------------------------------------------------------
