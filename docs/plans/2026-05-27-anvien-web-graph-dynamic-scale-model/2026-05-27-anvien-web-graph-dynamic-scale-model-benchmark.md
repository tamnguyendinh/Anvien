# Anvien Web Graph Dynamic Scale Model And Zoom Semantics Benchmark Ledger
...
| Final Anvien changed files at closure detect | 1 |
| Final Anvien changed symbols at closure detect | 2 |
...
| Metric | Value |
|---|---:|
| Web bundle | `anvien-web\dist\assets\index-B2G1nHHi.js` |
| Web bundle bytes | 2053493 |
| Web bundle SHA256 | `791B71A86CDAB764A84F0D81AF54390318A70EF3F9A0B67491AE1C181E1188BC` |
| Launcher web bundle | `anvien-launcher\web-dist\assets\index-B2G1nHHi.js` |
...
| Artifact | Bytes |
|---|---:|
| `anvien-web\test-results\graph-orientation-labels-G-5b603-labels-on-the-desktop-graph-chromium\graph-orientation-labels-desktop.png` | 240685 |
| `anvien-web\test-results\graph-orientation-labels-G-e5a0a-t-and-updates-after-filters-chromium\graph-orientation-labels-small-filtered.png` | 92846 |
| `anvien-web\test-results\graph-orientation-labels-G-537e2-ory-visible-on-default-load-chromium\graph-node-spacing-dense-desktop.png` | 301048 |
| `anvien-web\test-results\graph-orientation-labels-G-537e2-ory-visible-on-default-load-chromium\graph-node-spacing-dense-small.png` | 106522 |
...
| Metric | Value |
|---|---:|
| Web bundle | `anvien-web\dist\assets\index-C_89qSiV.js` |
| Web bundle bytes | 2055954 |
| Web bundle SHA256 | `55B5097D4DA274EE728771FBCA0F88E51195BFFEBA6963CCEFD22AE41539FAC1` |
| Launcher web bundle | `anvien-launcher\web-dist\assets\index-C_89qSiV.js` |
...
| Artifact | Bytes |
|---|---:|
| `anvien-web\test-results\graph-orientation-labels-G-5b603-labels-on-the-desktop-graph-chromium\graph-orientation-labels-desktop.png` | 238812 |
| `anvien-web\test-results\graph-orientation-labels-G-e5a0a-t-and-updates-after-filters-chromium\graph-orientation-labels-small-filtered.png` | 93029 |
| `anvien-web\test-results\graph-orientation-labels-G-537e2-ory-visible-on-default-load-chromium\graph-node-spacing-dense-desktop.png` | 286065 |
| `anvien-web\test-results\graph-orientation-labels-G-537e2-ory-visible-on-default-load-chromium\graph-node-spacing-dense-small.png` | 106634 |
