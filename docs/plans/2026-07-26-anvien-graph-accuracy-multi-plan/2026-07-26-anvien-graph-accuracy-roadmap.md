...
- `E4-P4B-DETECT1` and `E4-P4B-COMMIT1` close the documentation lag: final detect passed before isolated commit `11a37aa8ec0320dd93258c058b088d1070aa778d`; no P4-B source was reopened. P4-B1 is the sole open implementation slice; P4-C, P4-C2, Child 05, and target access remain locked.
...
- Main-owned `E4-P4B1-DETECT1` and `E4-P4B1-COMMIT1` remain pending until the fresh graph/change detection and one isolated P4-B1 commit. P4-C/P4-C2/Child 05 and `E:\cheapapp.org` remain locked.
