...
- Main-owned gates still pending are `E4-P4B-DETECT1` and `E4-P4B-COMMIT1`. P4-B1, P4-C, P4-C2, Child 05, and target access remain locked until the isolated P4-B commit succeeds.
