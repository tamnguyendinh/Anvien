...
- Pn-B remains open only for Main-owned final boundary/change detection and the isolated cleanup/report/ledger commit. Pn-C and Child 05 remain locked until that commit succeeds.
