...
| 03 | [TypeScript binding-pattern extraction](2026-07-28-03-typescript-binding-pattern-extraction/2026-07-28-03-typescript-binding-pattern-extraction-plan.md) | binding-pattern defect only | predecessor closed at `181b8cb800f5fe34fa6fe85ddd359f514ead9fb0`; P0-A accepted and committed at `17bd45845a218dccfa7cb09bde8195a14693bf50`; P3-A accepted and committed at `b4dbe5ccc2d0a77d0986b647c8054427ecca73c4`; P3-B is accepted and committed at `17254549a13ad81a560c18fbcc6ab8fe3ce5f111`; P3-B1 retains its REVIEW1 REJECT history, closes with focused REVIEW2 PASS, records final `309/17/13` detect, and is committed/pushed at `01f160e6e28ad74c1f379ce5ea47e643a5a14652`; P3-B2 has independent `E3-P3B2-REVIEW1` `PASS` and final staged `E3-P3B2-DETECT1` `242/11/11` with health `0/0/0` on the exact `definitions.go` / one-symbol `scopes.go` / focused `extract_test.go` boundary; only commit/push remains, and P3-B2A plus every later slice stay locked |
