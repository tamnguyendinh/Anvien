...
| Bounded direct-export definitions | 21 selected definitions were present at the accepted baseline and remain preserved | preserve the definitions and attach truthful direct export facts | `partial` | pending | `E0-P0A-VERIFY1`, `E0-P0A-VERIFY2`, `E4-P4B-SRC1` | extraction is correct for P4-B syntax; direct graph projection remains P4-C |
| Bounded export metadata | 0 of 21 selected definitions carried export/visibility metadata at the accepted baseline; P4-C now projects accepted facts and preserves access separation, while real-target `21/21` remains reserved for P4-C2 | 21 of 21 correct direct export facts and projections on the real target | `partial` | `414` current Graph Export records; target pending | `E0-P0A-VERIFY1`, `E0-P0A-VERIFY2`, `E4-P4B-SRC1`, `E4-P4C-TEST1`, `E4-P4C-REVIEW1` | preserve accepted P4-C projection; run P4-C2 only after commit |
...
| P4-C | graph projection, Ladybug persistence, and semantic consumer dialects are classified | sole open slice under `E4-P4C-AUTH1`; touch only consumers of accepted changed fields after fresh file-detail/impact evidence |
...
- [x] P4-B1 source, build, boundary, cleanup, Supervisor PASS, Main-owned detect, and isolated commit evidence is recorded; successor authority opens only P4-C under `E4-P4C-AUTH1`; P4-C2/Child 05 remain locked.
- [x] P4-C source, build, boundary, and independent Supervisor REVIEW1 `PASS` evidence is recorded; Main-owned detect and isolated commit remain pending; P4-C2/Child 05/target remain locked.
- [x] Main-owned `E4-P4C-DETECT1` is recorded from a fresh graph; exact semantic changed-path set and explicit untracked test/report staging boundary are known; isolated commit remains pending.
...
The bounded `0/21` baseline remains accepted, Child 03 is closed at `3e25f9ca75c9cb7d59bf228e6cc9aa0b81d738b4`, P4-A is committed at `479e8ac229a17f2f6f94be9a4d04e07d74ac4d43`, P4-B is committed at `11a37aa8ec0320dd93258c058b088d1070aa778d`, and P4-B1 is closed at `42d167aaf28446ac0b3de479a8afefabb8d06736` with source/build/boundary/Supervisor/detect evidence. P4-C source/build/boundary, independent Supervisor REVIEW1, and Main-owned `E4-P4C-DETECT1` are `PASS`; isolated commit remains pending. P4-C2/Child 05/target stay locked.
