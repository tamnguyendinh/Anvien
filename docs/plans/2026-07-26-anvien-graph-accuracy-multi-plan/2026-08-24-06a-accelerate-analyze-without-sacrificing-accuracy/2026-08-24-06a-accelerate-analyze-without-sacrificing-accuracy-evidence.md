...
- Acceptance: after both packets, one fresh visible A003 Supervisor reviews the exact candidate and affected tuple/policy/graph/output/lifecycle/resource boundary. Main alone decides disposition. PLAN2 changes no benchmark number, checkbox, streak, or speed claim.
