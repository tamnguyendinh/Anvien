...
| Field | Current value |
|-------|---------------|
| Attempt state | `A004 SUPERVISOR_PASS / NO_KEEP / ROLLBACK_COMPLETE / A005_CURRENT_BASIS_RECORDED / A005_ATTRIBUTION_COMPLETE / A005_ARCHITECT_COMPLETE / A005_PLAN_COMPLETE / A005_MAIN_VERIFIED / CODER_A005_READY_FOR_MEASUREMENT_HANDOFF / MAIN_HANDOFF_PASS / A005_FROZEN_PACKET_READY / TWO_TARGET_MEASUREMENTS_PENDING / D001_STREAK_1`; accepted A003 checkpoint remains baseline; all checkboxes unchanged |
| Attempt ID | `A005` |
...
| Next action | launch exactly one Cheapapp and one Restaurant Manager measurement in separate visible lanes from the same frozen A005 packet; each target uses its own accepted A003 before and may not retry, average, combine, or decide disposition |
...
- [ ] P2-A: Optimize Every Measured Parent And Child In Largest-First Order.
  ...
  - Implementation Gate:
    ...
    - A003 identity/checkpoint and WAL checkpoint `0f3a572331dd23d17688886fcbfebeb7d37ee35d` are complete; A004 is `SUPERVISOR_PASS / NO_KEEP / ROLLBACK_COMPLETE`. `E2-P2A-A005ARCH1/PLAN1/MAINVERIFY1/IMPACT1/SRC1/BUILD1/TEST1/BUILDFAIL1/PACKET1` are recorded and state is `A005_FROZEN_PACKET_READY / TWO_TARGET_MEASUREMENTS_PENDING / D001_STREAK_1`; only the two separate target measurement lanes may proceed.
