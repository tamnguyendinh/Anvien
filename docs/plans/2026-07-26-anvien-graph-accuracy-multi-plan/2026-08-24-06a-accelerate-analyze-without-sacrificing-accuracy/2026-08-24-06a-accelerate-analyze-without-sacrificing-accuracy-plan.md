...
| Field | Current value |
|-------|---------------|
| Attempt state | `A003_CHECKPOINT_COMPLETE / WAL_FIX_CHECKPOINT_COMPLETE / A004 SUPERVISOR_PASS / NO_KEEP / ROLLBACK_ACTIVE / D001_STREAK_1`; Supervisor task `01a03f21-63a6-7c53-a793-bb7cd459b858`; accepted A003 checkpoint remains the baseline; all checkboxes remain unchanged |
| Attempt ID | `A004` |
...
| Next action | surgically reverse only the A004 production/test bytes to exact HEAD/A003 baseline identity; do not rerun passed build/tests/measurements/Supervisor; after rollback, record current D001 basis and open fresh A005 Architect |
