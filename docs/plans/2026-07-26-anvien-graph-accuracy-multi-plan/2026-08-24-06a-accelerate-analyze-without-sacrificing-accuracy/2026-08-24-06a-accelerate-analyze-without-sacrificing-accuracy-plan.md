...
| Field | Current value |
|-------|---------------|
| Attempt state | `A004 SUPERVISOR_PASS / NO_KEEP / ROLLBACK_COMPLETE / A005_CURRENT_BASIS_RECORDED / A005_ATTRIBUTION_COMPLETE / A005_ARCHITECT_COMPLETE / A005_PLAN_COMPLETE / A005_MAIN_VERIFIED / CODER_A005_READY_FOR_MEASUREMENT_HANDOFF / MAIN_HANDOFF_PASS / A005_FROZEN_PACKET_READY / A005_TWO_TARGET_MEASUREMENTS_RECORDED / SUPERVISOR_A005_PASS / A005_NO_KEEP / A005_ROLLBACK_COMPLETE / A006_ARCHITECT_PENDING / D001_STREAK_2`; accepted A003 checkpoint remains baseline; all checkboxes unchanged |
| Attempt ID | `A005` |
...
| Post-measurement Supervisor | `E2-P2A-A005REVIEW1` records `SUPERVISOR_A005_PASS`; `E2-P2A-A005DECISION1` records Main `NO_KEEP`; `E2-P2A-A005ROLLBACK1` records exact accepted-state restoration |
...
| Next action | open one fresh visible A006 Architect on the same D001 at accepted A003 baseline and streak `2`, carrying A004/A005 no-KEEP evidence; no Coder or new measurement before the fresh direction and Planner translation |
...
- [ ] P2-A: Optimize Every Measured Parent And Child In Largest-First Order.
  ...
  - Work Steps:
    ...
    3. Planner refreshes the Current P2-A Attempt card and these execution steps to the Architect decision before Coder begins.
       ...
       - Current cursor: A003 remains closed at checkpoint `b6bf45bce95323aa6b53b182edfea8628bd8b463`; WAL checkpoint `0f3a572331dd23d17688886fcbfebeb7d37ee35d` is complete; A004 is `SUPERVISOR_PASS / NO_KEEP / ROLLBACK_COMPLETE`. A005 is `SUPERVISOR_A005_PASS / A005_NO_KEEP / A005_ROLLBACK_COMPLETE`; A006 Architect is pending at D001 streak `2`; parent/D001 remain unchecked and D002-D017 remain queued.
    ...
    5. After A005 production/build/test validation, record two independent candidate measurements without combining them, using each target's accepted A003 artifact as that target's `before` and one identifiable A005 candidate containing only the authorized PLAN1 production bytes plus the accepted measurement overlay as `after`.
       ...
       - Current A005 cursor: both A005 packets exist separately under `E2-P2A-A005CHEAPAPP1/RESTAURANT1`. Each records `30/30`, `17/17`, unchanged denominator, exact conservation/zero overlap and output/graph/DB/semantic parity. Their corrected runs overlapped in wall-clock execution as explicitly permitted by the measurement contract; the measured child/parent/analyzer/process values remain objective packet facts, while promotion/disposition remains locked to one fresh visible A005 Supervisor plus Main decision.
  ...
  - Implementation Gate:
    ...
    - A003 identity/checkpoint and WAL checkpoint `0f3a572331dd23d17688886fcbfebeb7d37ee35d` are complete; A004 is `SUPERVISOR_PASS / NO_KEEP / ROLLBACK_COMPLETE`. `E2-P2A-A005ARCH1/PLAN1/MAINVERIFY1/IMPACT1/SRC1/BUILD1/TEST1/BUILDFAIL1/PACKET1/CHEAPAPP1/RESTAURANT1/REVIEW1/DECISION1/ROLLBACK1` are recorded and state is `SUPERVISOR_A005_PASS / A005_NO_KEEP / A005_ROLLBACK_COMPLETE / A006_ARCHITECT_PENDING / D001_STREAK_2`; only one fresh A006 Architect may proceed.
