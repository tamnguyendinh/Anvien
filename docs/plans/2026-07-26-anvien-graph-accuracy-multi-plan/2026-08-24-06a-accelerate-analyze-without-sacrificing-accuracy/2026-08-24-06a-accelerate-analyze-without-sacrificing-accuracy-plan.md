...
| Next action | open exactly one fresh visible A004 Supervisor for the exact candidate and both complete target packets; Supervisor reviews correctness/equivalence only, then Main records disposition from the measured child/parent/process rule |
