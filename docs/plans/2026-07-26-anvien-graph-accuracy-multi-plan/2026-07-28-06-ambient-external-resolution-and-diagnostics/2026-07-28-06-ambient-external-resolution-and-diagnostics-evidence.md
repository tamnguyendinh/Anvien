...
| `E6-P6C2-DETECT1` | detect-changes result before commit | recorded on accepted bytes; final Main explicit-path analyze/detect runs once after planner finalization |
