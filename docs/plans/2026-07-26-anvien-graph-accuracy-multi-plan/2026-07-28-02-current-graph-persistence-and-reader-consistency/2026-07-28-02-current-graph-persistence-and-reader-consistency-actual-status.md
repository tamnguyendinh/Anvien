...
| P2-C | corrected reader denominator is `8`, with C09/C10/C11/C16 edit and C12-C15 validate-only | next after Git confirms the P2-B isolated commit; refresh graph/impact and consume only the accepted explicit persisted fields while preserving excluded transports/copiers |
