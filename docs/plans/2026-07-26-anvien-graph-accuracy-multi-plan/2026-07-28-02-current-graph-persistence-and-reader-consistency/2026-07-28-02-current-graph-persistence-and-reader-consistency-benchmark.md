...
- Pn-B cleanup is recorded as `E3-PNB-CLEANUP1`; its `77` current-chain paths, `92` classified lifecycle entries, and five-path / `120`-byte deletion are lifecycle evidence rather than product/runtime benchmarks.
