...
- [x] Pn-B: Remove dead work created during this plan.
  ...
  - Work Steps:
    ...
    3. Record the accepted cleanup boundary in the roadmap/ledgers/notes, run fresh staged all-scope change detection, and create one isolated report/docs commit before Pn-C can open.
