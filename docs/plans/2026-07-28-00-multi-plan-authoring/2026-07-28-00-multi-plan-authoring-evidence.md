...
- `E3-P3B-CUTOVER1`: Commit `2fec691a6aad936e00aa31af9f851ec097a321cb` makes the roadmap active and the legacy plan `superseded / reference-only` with a direct pointer; exactly one active campaign authority remains.
