...
| Frozen transformation crosswalk | historical crosswalk remaps later source phase/slice IDs to child-local P1 IDs | preserve every source phase/slice ID unchanged and prove exact copy boundaries | wrong | 98 historical rows require source-ID-preserving correction before P2-B | `E1-P1A-MAP1`, `E1-P1A-MAP2`, `E2-P2A-REBUILD1` | correct the crosswalk before opening P2-B; do not consume remapped destinations |
...
| Child-independent ledgers | legacy ledgers remain historical; rebuilt child 01 owns phase-scoped evidence, benchmark, and actual-status ledgers | each child owns a complete phase-scoped ledger set and qualified cross-plan references | partial | 3 legacy ledgers / 3 of 21 child ledger files | `E0-P0A-SRC2`, `E0-P0A-DECISION2`, `E2-P2A-REBUILD1` | author independent ledgers sequentially for children 02-07 |
| Reader matrix ownership | one byte-identical matrix exists in the legacy source root; child 02 is absent | child 02 is sole future mutation owner; other children link inspect-only | missing future owner binding | 1 file / 0 authored mutation owner | `E0-P0A-SRC2`, `E0-P0A-OWNER1`, `E2-P2B-RESET1` | preserve matrix unchanged; bind ownership only when Child 02 is rebuilt |
| Multi-plan authority | separate multi-plan root contains roadmap plus rebuilt child 01; legacy remains active | separate multi-plan root becomes sole active campaign index after all seven children and P3-B PASS | partial | 5 candidate files of 29 | `E1-P1B-ROADMAP1`, `E2-P2A-REBUILD1`, `E0-P0A-AUTH1`, `E2-P2A1-COMMIT1` | commit Child 01; keep later children absent until sequential authoring |
...
| Execution authorization | user ordered docs-only multi-plan authoring; rebuilt Child 01 passed bounded Supervisor; no production implementation is authorized | author children sequentially; child implementation requires separate owner direction and child gates | correct | N/A | `E1-P1A-AUTH1`, `E2-P2A1-USER1`, `E2-P2A-REBUILD1`, `E2-P2A-SUP2` | commit Child 01 only; do not open Child 02 or implementation yet |
...
- [x] Current authoring blocker is recorded: P2-B cannot open until rebuilt Child 01 is committed and the historical remap crosswalk is corrected to preserve source IDs.
