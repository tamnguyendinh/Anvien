...
| Phase | Metric | Unit | Baseline | Latest | Final | Target | Delta | Evidence |
|-------|--------|------|----------|--------|-------|--------|-------|----------|
| P3 | Web adapter compact related-file rows preserved in fixture | rows | 0 | 2 | 2 | adapter preserves compact related-file rows for P3-B render | +2 | `E3-P3A-TEST1` |
| P3 | Web file-detail related-file rows rendered in fixture | rows | 0 | 2 | 2 | fixture-specific expected count | +2 | `E3-P3B-TEST1` |
| P3 | Runtime compact endpoint response size for selected smoke file | characters | pending | 60946 | 60946 | record final | N/A | `E3-P3C-RUNTIME1` |
