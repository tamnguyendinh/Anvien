...
| P2-D | MCP/agent file-context consumers share `BuildFileContext` but had no planned surface decision | start P2-D; preserve expanded MCP compatibility or add explicit compact/expanded MCP contract with tests |
