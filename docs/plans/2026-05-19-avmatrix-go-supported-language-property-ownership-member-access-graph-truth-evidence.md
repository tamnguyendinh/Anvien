...
analyzed E:\Website
files: scanned=1870 parsed=998 unsupported=872 failed=0
graph: nodes=27956 relationships=58732 path=E:\Website\.avmatrix\graph.json
```
...
analyzed E:\AVmatrix-GO
files: scanned=682 parsed=527 unsupported=155 failed=0
graph: nodes=20324 relationships=50953 path=E:\AVmatrix-GO\.avmatrix\graph.json
```
...
go run ./cmd/property-access-audit -repo E:\AVmatrix-GO -graph .tmp\p3f-property-access-avmatrix-go-graph-20260519.json -out .tmp\p3f-property-access-avmatrix-go-20260519.json -max-examples 20
```
...
go run ./cmd/access-candidate-audit -repo E:\AVmatrix-GO -out .tmp\p3f-access-candidates-avmatrix-go-20260519.json -max-examples 20
```
