...
Date: 2026-07-28
Status: candidate / child 01 committed `ce82a341` / child 02 committed `a1c66865` / child 03 authoring active / children 04-07 not authored / legacy plan remains active
...
| 03 | `2026-07-28-03-typescript-binding-pattern-extraction` | Recursive binding facts, declaration contexts, graph and adapter projection | P3 | 17 | authoring active / not yet authored | Requires `2026-07-28-02-versioned-persistence-and-v2-cutover::E2-PNC-HANDOFF1` (source `P8-C`, local `Pn-C`), including identity-v2 plus S0-S11/reader-matrix inspect-only baseline |
