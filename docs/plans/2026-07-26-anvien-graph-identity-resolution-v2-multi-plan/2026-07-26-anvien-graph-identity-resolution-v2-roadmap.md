...
Date: 2026-07-28
Status: candidate / child 01 committed `ce82a341` / child 02 committed `a1c66865` / child 03 committed `35a0611c` / child 04 committed `2de220bb` / child 05 committed `b19256e6` / child 06 authoring active / child 07 not authored / legacy plan remains active
...
| 06 | `2026-07-28-06-ambient-external-resolution-and-diagnostics` | Declaration universe, external authorization/materialization, immutable outcomes, diagnostics | P6 | 6 | authoring active / not yet authored | Requires `2026-07-28-05-module-export-and-reexport-resolution::E2-PNC-HANDOFF1` (source `P8-C`, local `Pn-C`); consumes `2026-07-28-02-versioned-persistence-and-v2-cutover::E2-PNC-HANDOFF1` inspect-only |
