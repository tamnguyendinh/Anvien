...
- [ ] P1-A: Add living-status refresh behavior to the planner skill.
  ...
  - Work Steps:
    ...
    3. Keep evidence references lightweight and avoid duplicating `evidence.md`.
  - Implementation Gate: P0 actual-status decision is complete and target files are low-risk documentation files.
  - Acceptance: the changed skill and template clearly state when and how to refresh actual-status.
...
- Blast radius is LOW for both target markdown files.
