# Anvien Go Supported-Language Property Ownership And Member Access Graph Truth Benchmark
...
Companion evidence: [2026-05-19-anvien-supported-language-property-ownership-member-access-graph-truth-evidence.md](2026-05-19-anvien-supported-language-property-ownership-member-access-graph-truth-evidence.md)
...
- Do not compare `anvien` final graph edge counts directly to `anvien-main` internal counters.
...
- Combined benchmark: `reports\benchmark\2026-05-16-120908-anvien-self-analyze.json`
- Go-heavy scenario: `scenarios.anvienGoSelf`
- TypeScript-heavy scenario: `scenarios.websiteTypescriptHeavy`

No `anvien-main` rerun is required for the Website comparison because `E:\Website` is treated as unchanged for this benchmark.

| Scenario | anvien | anvien-main | Go speedup | Go nodes | main nodes | Go relationships | main relationships |
|---|---:|---:|---:|---:|---:|---:|---:|
| `E:\Anvien` Go-heavy | 13,588.1 ms | 63,215.2 ms | 4.65x | 19,984 | 17,539 | 47,622 | 39,019 |
...
| Metric | anvien | anvien-main | Note |
|---|---:|---:|---|
...
- The actionable benchmark gap is property ownership/access usefulness: `anvien` has `5,222` Website `Property` nodes but only `3` `HAS_PROPERTY` edges and `3` `ACCESSES` edges.
...
|---|---|---|---|
| Existing workload baseline | `reports\benchmark\2026-05-16-120908-anvien-self-analyze.json` | Website: `Property=5,222`, `HAS_PROPERTY=3`, `ACCESSES=3`; Go speedups `4.65x` and `3.39x` | recorded |
...
| P1 Anvien baseline gate | `.tmp\p1-property-access-anvien-baseline-20260519.json` | `Property=3,046`, `HAS_PROPERTY=2,708`, `ACCESSES=2,724`, `go=2,469`, `typescript=577`, `invalidHasPropertyEdges=0` | recorded |
| P1 language taxonomy | baseline gate artifacts | Website `false_orphan=3,627`; Anvien `false_orphan=21`; no invalid synthetic edges | recorded |
| P1 access candidate taxonomy | `.tmp\p1-access-candidates-website-20260519.json`, `.tmp\p1-access-candidates-anvien-20260519.json` | Website `total=24,542 resolved=3`; Anvien `total=21,098 resolved=5,112` | recorded |
| P2 ownership validation | `.tmp\p2-property-access-website-20260519.json`, `.tmp\p2-property-access-anvien-20260519.json` | Website `HAS_PROPERTY=5,129`, `real_edge_missing=392`, invalid edges `0`; Anvien `HAS_PROPERTY=2,762`, `real_edge_missing=12`, invalid edges `0` | recorded |
| P2-D Go anonymous struct classification | `.tmp\p2d-property-access-anvien-20260519.json` | Go `go_anonymous_struct_field=206`, Go `true_no_edge=206`, Go `unknown=0`; no new `HAS_PROPERTY` emitted | recorded |
| P2-E remaining ownership clusters | `.tmp\p2e-property-access-website-20260519.json`, `.tmp\p2e-property-access-anvien-20260519.json` | Website `HAS_PROPERTY=5,922`, `real_edge_missing=0`; Anvien `HAS_PROPERTY=2,769`, `real_edge_missing=0`; invalid edges `0` | recorded |
| P3-A post-ownership access taxonomy | `.tmp\p3a-access-candidates-website-20260519.json`, `.tmp\p3a-access-candidates-anvien-20260519.json` | Website `total=24,542 resolved=3`; Anvien `total=21,132 resolved=5,128`; biggest bucket remains `missing_receiver_type` | recorded |
| P3-B/P3-D access validation | `.tmp\p3b-property-access-website-20260519.json`, `.tmp\p3b-access-candidates-website-20260519.json`, `.tmp\p3b-property-access-anvien-20260519.json`, `.tmp\p3b-access-candidates-anvien-20260519.json` | Website final `ACCESSES=2,769`, candidate `resolved=4,978`; Anvien final `ACCESSES=2,746`, candidate `resolved=5,110`; invalid owner edges `0` | recorded |
| P3-E missing-owner-link closure | `.tmp\p3e-access-candidates-website-20260519.json`, `.tmp\p3e-access-candidates-anvien-20260519.json` | Website `missing_owner_link=0`; Anvien `missing_owner_link=0`; invalid owner edges `0` | recorded |
| P3-F imported member receiver cluster | `.tmp\p3f-property-access-website-20260519.json`, `.tmp\p3f-access-candidates-website-20260519.json`, `.tmp\p3f-property-access-anvien-20260519.json`, `.tmp\p3f-access-candidates-anvien-20260519.json` | Website final `ACCESSES=2,770`, candidate `resolved=4,979`; Anvien final `ACCESSES=5,018`, candidate `resolved=8,431`; invalid owner edges `0`; remaining buckets explicitly deferred | recorded |
| P5 final gate | `.tmp\final-property-access-website-20260519.json`, `.tmp\final-access-candidates-website-20260519.json`, `.tmp\final-property-access-anvien-20260519.json`, `.tmp\final-access-candidates-anvien-20260519.json` | Website `ACCESSES=2,770`, `real_edge_missing=0`; Anvien `ACCESSES=5,024`, `real_edge_missing=0`; invalid edges `0`; provider fixture matrix passed | recorded |
...
- Anvien graph snapshot: `.tmp\p1-property-access-anvien-graph-20260519.json`
- Anvien gate output: `.tmp\p1-property-access-anvien-baseline-20260519.json`
...
| `E:\Anvien` | 3,046 | 2,708 | 338 | 2,708 | 2,724 | 0 |
...
| `E:\Anvien` | Go | 2,469 | 2,263 | 206 |
| `E:\Anvien` | TypeScript | 577 | 445 | 132 |
...
| `E:\Anvien` | `go_owner_linked_struct` | 2,263 |
| `E:\Anvien` | `tsjs_interface_property_signature` | 449 |
| `E:\Anvien` | `go_typed_property_without_owner` | 206 |
| `E:\Anvien` | `tsjs_destructuring_or_binding_pattern` | 58 |
| `E:\Anvien` | `tsjs_typed_shape_or_binding_property` | 26 |
| `E:\Anvien` | `tsjs_runtime_object_literal_key` | 24 |
| `E:\Anvien` | `tsjs_type_alias_object_literal_member` | 9 |
| `E:\Anvien` | `tsjs_class_field` | 8 |
| `E:\Anvien` | `tsjs_unclassified_property` | 3 |
...
- Anvien access candidate output: `.tmp\p1-access-candidates-anvien-20260519.json`
...
| `E:\Anvien` | 5,862 ms | 21,098 | 5,112 | 15,986 | 5,112 | 50,282 |
...
| `E:\Anvien` | Go | 19,059 | 4,975 | 14,084 |
| `E:\Anvien` | TypeScript | 2,039 | 137 | 1,902 |
...
| `E:\Anvien` | 5,112 | 11,418 | 3,619 | 910 | 14 | 10 | 15 | 0 |
...
- Anvien graph snapshot: `.tmp\p2-property-access-anvien-graph-20260519.json`
- Anvien gate output: `.tmp\p2-property-access-anvien-20260519.json`
...
| `E:\Anvien` | 15,755.6 ms | 682 | 527 | 20,241 | 48,415 |
...
| `E:\Anvien` | 3,046 | 3,089 | 2,708 | 2,762 | 2,708 | 2,762 | 2,724 | 2,751 | 21 | 12 | 0 |
...
| `E:\Anvien` | Go | 2,508 | 2,302 | 206 |
| `E:\Anvien` | TypeScript | 581 | 460 | 121 |
...
| `E:\Website` | `tsjs_class_field` | 3 |
| `E:\Anvien` | `go_owner_linked_struct` | 2,302 |
| `E:\Anvien` | `go_typed_property_without_owner` | 206 |
| `E:\Anvien` | `tsjs_interface_property_signature` | 449 |
| `E:\Anvien` | `tsjs_destructuring_or_binding_pattern` | 58 |
| `E:\Anvien` | `tsjs_typed_shape_or_binding_property` | 24 |
| `E:\Anvien` | `tsjs_runtime_object_literal_key` | 24 |
| `E:\Anvien` | `tsjs_type_alias_object_literal_member` | 15 |
| `E:\Anvien` | `tsjs_class_field` | 8 |
| `E:\Anvien` | `tsjs_unclassified_property` | 3 |
...
| `E:\Anvien` | 2,762 | 12 | 82 | 233 | 2,762 | 12 | 82 | 233 |
...
- `ACCESSES` was not the main P2 target. Website stayed at `3`; Anvien increased from `2,724` to `2,751` as a downstream effect of improved owner-member indexing.
...
- Anvien gate output: `.tmp\p2d-property-access-anvien-20260519.json`
...
Anvien Go-language taxonomy after P2-D:
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|
| `E:\Anvien` | 3,089 | 2,762 | 2,751 | 2,762 | 12 | 288 | 27 | 0 |
| `E:\Website` | 6,905 | 5,129 | 3 | 5,129 | 392 | 469 | 915 | 0 |

P2-D interpretation:

- The previous Anvien `go_typed_property_without_owner=206` bucket is not a missing owner bucket.
...
- Anvien graph snapshot: `.tmp\p2e-property-access-anvien-graph-20260519.json`
- Anvien gate output: `.tmp\p2e-property-access-anvien-20260519.json`
...
| `E:\Anvien` | 14,805.4 ms | 682 | 527 | 20,268 | 48,460 |
...
| `E:\Anvien` | 3,089 | 3,096 | 2,762 | 2,769 | 2,751 | 2,754 | 12 | 0 | 0 |
...
| `E:\Anvien` | Class | 8 |
| `E:\Anvien` | Interface | 419 |
| `E:\Anvien` | Property | 25 |
| `E:\Anvien` | Struct | 2,302 |
| `E:\Anvien` | TypeAlias | 15 |
...
| `E:\Anvien` | `go_owner_linked_struct` | 2,302 |
| `E:\Anvien` | `go_anonymous_struct_field` | 206 |
| `E:\Anvien` | `tsjs_interface_property_signature` | 419 |
| `E:\Anvien` | `tsjs_inline_type_literal_property` | 92 |
| `E:\Anvien` | `tsjs_owner_linked_property` | 25 |
| `E:\Anvien` | `tsjs_runtime_object_literal_key` | 24 |
| `E:\Anvien` | `tsjs_type_alias_object_literal_member` | 15 |
| `E:\Anvien` | `tsjs_class_field` | 8 |
| `E:\Anvien` | `tsjs_typed_shape_or_binding_property` | 3 |
| `E:\Anvien` | `tsjs_destructuring_or_binding_pattern` | 2 |
...
| `E:\Anvien` | 2,769 | 0 | 324 | 3 | 2,769 | 0 | 324 | 3 |
...
- Anvien access candidate output: `.tmp\p3a-access-candidates-anvien-20260519.json`
...
| `E:\Anvien` | 5,227 ms | 21,132 | 5,128 | 16,004 | 5,128 | 50,360 |
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|
| `E:\Website` | 3 | 13,512 | 9,660 | 1,313 | 53 | 1 | 0 | 0 |
| `E:\Anvien` | 5,128 | 11,436 | 3,619 | 910 | 14 | 10 | 15 | 0 |
...
- Anvien resolved accesses increased from `5,112` to `5,128`, but `missing_receiver_type` remains the largest bucket.
- `missing_owner_link` is small after Phase 2: Website `1`, Anvien `10`.
...
- Anvien graph snapshot: `.tmp\p3b-property-access-anvien-graph-20260519.json`
- Anvien property/access gate output: `.tmp\p3b-property-access-anvien-20260519.json`
- Anvien access candidate output: `.tmp\p3b-access-candidates-anvien-20260519.json`
...
| `E:\Anvien` | 14,784.4 ms | 682 | 527 | 20,282 | 48,550 |
...
| `E:\Anvien` | 3,096 | 2,769 | 2,746 | 0 | 324 | 3 | 0 |
...
| `E:\Anvien` | 5,279 ms | 21,165 | 5,110 | 16,055 | 5,110 | 50,445 |
...
| `E:\Anvien` | 5,110 | 11,464 | 3,622 | 910 | 14 | 10 | 35 | 0 |
...
| `E:\Anvien` | Go | 19,126 | 4,970 | 14,156 |
| `E:\Anvien` | TypeScript | 2,039 | 140 | 1,899 |
...
- Anvien is not the main beneficiary of this TS/JS-heavy cluster. Its small final `ACCESSES` decrease is recorded for audit and will be watched in P3-E/P3-F instead of hidden.
...
- Anvien graph snapshot: `.tmp\p3e-property-access-anvien-graph-20260519.json`
- Anvien property/access gate output: `.tmp\p3e-property-access-anvien-20260519.json`
- Anvien access candidate output: `.tmp\p3e-access-candidates-anvien-20260519.json`
...
| `E:\Anvien` | 15,928.0 ms | 682 | 527 | 20,318 | 48,597 |
...
|---|---:|---:|---:|---:|---:|---:|---:|
| `E:\Website` | 7,097 | 5,922 | 2,769 | 0 | 1,156 | 19 | 0 |
| `E:\Anvien` | 3,096 | 2,769 | 2,747 | 0 | 324 | 3 | 0 |
...
| `E:\Anvien` | 5,303 ms | 21,195 | 5,114 | 16,081 | 5,114 | 50,483 |
...
| `E:\Anvien` | 5,114 | 11,485 | 3,638 | 910 | 14 | 0 | 34 | 0 |
...
## P3-F Imported Member Receiver Cluster And Deferrals

Date: 2026-05-19

Artifacts:

- Website analyze benchmark: `.tmp\p3f-website-analyze-20260519.json`
- Website graph snapshot: `.tmp\p3f-property-access-website-go-graph-20260519.json`
- Website property/access gate output: `.tmp\p3f-property-access-website-20260519.json`
- Website access candidate output: `.tmp\p3f-access-candidates-website-20260519.json`
- Anvien analyze benchmark: `.tmp\p3f-anvien-analyze-20260519.json`
- Anvien graph snapshot: `.tmp\p3f-property-access-anvien-graph-20260519.json`
- Anvien property/access gate output: `.tmp\p3f-property-access-anvien-20260519.json`
- Anvien access candidate output: `.tmp\p3f-access-candidates-anvien-20260519.json`

Analyze runtime and graph size:

| Workload | Analyze runtime | Files scanned | Files parsed | Graph nodes | Graph relationships |
|---|---:|---:|---:|---:|---:|
| `E:\Website` | 16,744.5 ms | 1,870 | 998 | 27,956 | 58,732 |
| `E:\Anvien` | 14,882.9 ms | 682 | 527 | 20,324 | 50,953 |
...
| `E:\Anvien` | 3,096 | 2,769 | 5,018 | 0 | 324 | 3 | 0 |

Final graph delta from P3-E:

| Workload | P3-E `ACCESSES` | P3-F `ACCESSES` | Delta |
|---|---:|---:|---:|
| `E:\Website` | 2,769 | 2,770 | +1 |
| `E:\Anvien` | 2,747 | 5,018 | +2,271 |

Access candidate taxonomy:

| Workload | Analyze runtime | Access candidates | Resolved | Unresolved | Final graph resolved accesses | Resolution unresolved references |
|---|---:|---:|---:|---:|---:|---:|
| `E:\Website` | 8,037 ms | 24,542 | 4,979 | 19,563 | 4,979 | 59,288 |
| `E:\Anvien` | 6,327 ms | 21,242 | 8,431 | 12,811 | 8,431 | 47,234 |
...
| `E:\Anvien` | 8,431 | 7,499 | 4,354 | 910 | 14 | 0 | 34 | 0 |

P3-F interpretation:

- Imported workspace member accesses are now real graph edges where the imported target is resolved inside the analyzed repo.
- Imported receivers whose target is not resolved in the workspace are classified as `external_library_type`, not `missing_receiver_type`.
- The self repo benefits most because Go package/member references are common: candidate `resolved` increased from `5,114` to `8,431`, and final graph `ACCESSES` increased from `2,747` to `5,018`.
- Website gets a small graph increase because most remaining unresolved receivers are not imported workspace members.
...
- Anvien analyze benchmark: `.tmp\final-anvien-analyze-20260519.json`
- Anvien graph snapshot: `.tmp\final-property-access-anvien-graph-20260519.json`
- Anvien property/access gate output: `.tmp\final-property-access-anvien-20260519.json`
- Anvien access candidate output: `.tmp\final-access-candidates-anvien-20260519.json`
...
| `E:\Anvien` | 15,689.4 ms | 682 | 527 | 20,352 | 50,978 |
...
|---|---:|---:|---:|---:|---:|---:|---:|
| `E:\Website` | 7,097 | 5,922 | 2,770 | 0 | 1,156 | 19 | 0 |
| `E:\Anvien` | 3,096 | 2,769 | 5,024 | 0 | 324 | 3 | 0 |
...
| `E:\Anvien` | 6,289 ms | 21,255 | 8,444 | 12,811 | 8,444 | 47,249 |
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|
| `E:\Website` | 4,979 | 10,619 | 6,295 | 1,313 | 53 | 0 | 1,174 | 109 |
| `E:\Anvien` | 8,444 | 7,499 | 4,354 | 910 | 14 | 0 | 34 | 0 |
